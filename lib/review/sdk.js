...
(function () {
  ...
  function ensureZoomStyle() {
    ...
    zoomStyleEl.textContent = [
      ...
      ".brain-diagram-hover { position: fixed; z-index: 2147483646; border: 2px solid #6d5dfc;",
      "  border-radius: 4px; pointer-events: none; display: none; box-sizing: border-box; }",
      ".brain-diagram-flash { position: fixed; z-index: 2147483646; border: 2px solid #6d5dfc;",
      "  background: rgba(109,93,252,.18); border-radius: 4px; pointer-events: none;",
