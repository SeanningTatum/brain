...
import { ensurePlan, recordReviewRound, planContext, slugForFile, executionContext, brainCheck, featureExists, watchContext, addAnnotation, removeAnnotation } from "./brain-data.js";
...
const ROUTES = [
  ...
  // Both patterns are $-anchored (distinct, non-overlapping), so match order
  // is not load-bearing here — kept above /annotate anyway per convention
